...
function draw() {
    ...
    if (key_exists('mail', $_SERVER)) {
        $params['email'] = $_SERVER['mail'];
    } else if (key_exists('OIDC_CLAIM_external_authn', $_SERVER)) {
    ...
    $params['given_name'] = '';
    if (key_exists('givenName', $_SERVER)) {
        $params['given_name'] = $_SERVER['givenName'];
    } else if (key_exists('OIDC_CLAIM_given_name', $_SERVER)) {
        $params['given_name'] = $_SERVER['OIDC_CLAIM_given_name'];
    }
    $params['family_name'] = '';
    if (key_exists('sn', $_SERVER)) {
        $params['family_name'] = $_SERVER['sn'];
    } else if (key_exists('OIDC_CLAIM_family_name', $_SERVER)) {
